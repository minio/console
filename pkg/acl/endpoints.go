...
// logSearchActionSet contains the list of admin actions required for this endpoint to work
var logSearchActionSet = ConfigurationActionSet{
	actionTypes: iampolicy.NewActionSet(
		iampolicy.AllAdminActions,
	),
	actions: iampolicy.NewActionSet(
