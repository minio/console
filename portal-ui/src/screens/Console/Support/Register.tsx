            ...
            <Box>
              <Box className="step-row">
                <div className="step-text">
                  {t("Click on the link to register this cluster in SUBNET")}
                </div>
              </Box>
              ...
              >
                {t(
                  "If this machine does not have internet connection, Copy paste the following URL in a browser where you access SUBNET and follow the instructions to complete the registration"
                )}
              </div>
            </Box>
          </Box>
