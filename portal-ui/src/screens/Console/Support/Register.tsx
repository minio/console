...
const Register = ({
    ...
    const [subnetOrganizations, setSubnetOrganizations] = useState<SubnetOrganization[]>([]);
                ...
                <Grid item xs={12} marginTop={"25px"}>
                    <Box sx={{
                      ...
                      //  border: "1px solid #eaeaea",
                        ...
                        Login to <Link href="https://subnet.min.io" target="_blank"
                                       className={classes.link}>SUBNET</Link> to avail support for
                        this MinIO cluster
                    </Box>
                </Grid>):null}
