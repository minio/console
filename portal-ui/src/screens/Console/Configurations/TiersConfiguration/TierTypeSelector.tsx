  ...
  return (
    <Fragment>
      <PageHeader
        label={
          <Fragment>
            <BackLink to={IAM_PAGES.TIERS} label={t("Tier Types")} />
          </Fragment>
        }
            ...
            <HelpBox
              ...
              help={
                <Fragment>
                  ...
                  <br />
                  <br />
                  {t("MinIO supports the following Tier types:")}
                  <br />
                  <ul>
                    <li>
                      <a
                        ...
                        rel="noreferrer"
                      >
                        {t("MinIO or other S3-compatible storage")}
                      </a>
                    </li>
                    <li>
                      <a
                    ...
                    <li>
                      <a
                        ...
                        rel="noreferrer"
                      >
                        {t("Microsoft Azure Blob Storage")}
                      </a>
                    </li>
                  </ul>
                </Fragment>
