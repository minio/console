...
import {setErrorSnackMessage, setServerNeedsRestart} from "../../../../systemSlice";
...
const ImportConfigButton = () => {
    ...
    const [refreshPage, setRefreshPage] = useState<boolean|undefined>(undefined)
    ...
    return (
        <Fragment>
            ...
            />
            <TooltipWrapper
                tooltip="The file must be valid and  should have valid config values">
                <Button
                    id={"import-config"}
                    onClick={() => {
