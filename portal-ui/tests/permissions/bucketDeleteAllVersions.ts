...
test
  .before(async (t) => {
    ...
    await t
      ...
      .wait(5000)
      .click("#object-list-wrapper > div > div.MuiGrid-root.MuiGrid-item.MuiGrid-grid-xs-12.css-15j76c0 > div > div:nth-child(1) > div > div.ReactVirtualized__Grid.ReactVirtualized__Table__Grid > div > div")
