...
type ListTenantCertificateSigningRequestOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.ListCertificateSigningRequest `json:"body,omitempty"`
}
...
func (o *ListTenantCertificateSigningRequestOK) WithPayload(payload *models.ListCertificateSigningRequest) *ListTenantCertificateSigningRequestOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the list tenant certificate signing request o k response
func (o *ListTenantCertificateSigningRequestOK) SetPayload(payload *models.ListCertificateSigningRequest) {
	o.Payload = payload
}
