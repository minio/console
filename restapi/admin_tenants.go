...
func getPodEventsResponse(session *models.Principal, params admin_api.GetPodEventsParams) (models.EventListWrapper, *models.Error) {
	...
	/*obj, err := clientset.CoreV1().Pods(params.Namespace).Get(ctx, params.PodName, metav1.GetOptions{})
	if err != nil {
		return nil, prepareError(err)
	}*/
	events, _ := clientset.CoreV1().Events(params.Namespace).List(ctx, metav1.ListOptions{})
