...
/*GetServerInfoOK A successful response.
...
type GetServerInfoOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.ServerInfoResponse `json:"body,omitempty"`
}
...
func (o *GetServerInfoOK) WithPayload(payload *models.ServerInfoResponse) *GetServerInfoOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get server info o k response
func (o *GetServerInfoOK) SetPayload(payload *models.ServerInfoResponse) {
	o.Payload = payload
}
...
/*GetServerInfoDefault Generic error response.
...
func (o *GetServerInfoDefault) WithPayload(payload *models.Error) *GetServerInfoDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get server info default response
func (o *GetServerInfoDefault) SetPayload(payload *models.Error) {
	o.Payload = payload
}
