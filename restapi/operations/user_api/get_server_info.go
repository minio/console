...
type GetServerInfoHandlerFunc func(GetServerInfoParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn GetServerInfoHandlerFunc) Handle(params GetServerInfoParams, principal *models.Principal) middleware.Responder {
	return fn(params, principal)
}

// GetServerInfoHandler interface for that can handle valid get server info params
type GetServerInfoHandler interface {
	Handle(GetServerInfoParams, *models.Principal) middleware.Responder
}
...
/*GetServerInfo swagger:route GET /storage-info UserAPI getServerInfo

Get MinIO's Server Info
