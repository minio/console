...
var (
	...
	ErrUnableToGetTenantHealthReport    = errors.New("unable to get tenant health report")
	ErrUnableToSaveTenantHealthReport   = errors.New("Unable to save MinIO diagnostics report")
	ErrUnableToUploadTenantHealthReport = errors.New("Unable to upload MinIO diagnostics report to Subnet")
