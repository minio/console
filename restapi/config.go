...
func GetHostname() string {
	return strings.ToLower(env.Get(McsHostname, "localhost"))
}

func GetSSLHostname() string {
	return strings.ToLower(env.Get(McsTLSHostname, GetHostname()))
}
...
func getSecureSSLHost() string {
	return env.Get(McsSecureSSLHost, fmt.Sprintf("%s:%d", GetSSLHostname(), TLSPort))
}
