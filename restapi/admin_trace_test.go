...
func TestAdminTraceWithPath(t *testing.T) {
	assert := assert.New(t)
	adminClient := AdminClientMock{}
	mockWSConn := mockConn{}
	function := "startTraceInfo(ctx, )"
...
func TestAdminTraceWithStatusCode(t *testing.T) {
	assert := assert.New(t)
	adminClient := AdminClientMock{}
	mockWSConn := mockConn{}
	function := "startTraceInfo(ctx, )"
...
func TestAdminTraceWithMethod(t *testing.T) {
	assert := assert.New(t)
	adminClient := AdminClientMock{}
	mockWSConn := mockConn{}
	function := "startTraceInfo(ctx, )"
...
func TestAdminTraceWithFuncName(t *testing.T) {
	assert := assert.New(t)
	adminClient := AdminClientMock{}
	mockWSConn := mockConn{}
	function := "startTraceInfo(ctx, )"
